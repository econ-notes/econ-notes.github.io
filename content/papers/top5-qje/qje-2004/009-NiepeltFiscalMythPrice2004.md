...
date: 2004-12-22
tags: ["Prices", "Fiscal Policies", "ToRead"]
---

## Abstract 
I examine the "fiscal theory of the price level" according to which "non-Ricardian" policy and predetermined nominal government debt fiscally determine prices. I argue that the non-Ricardian policy assumption and, by implication, fiscal price level determination are inconsistent with an equilibrium in which all asset holdings reflect optimal household choices. In such an equilibrium, policy must be Ricardian even if, in some states of nature, the government defaults or commits to an arbitrary real primary surplus sequence. 
